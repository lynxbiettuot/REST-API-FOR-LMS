const roles = {
    Admin: ['course:create', 'course:read', 'course:update:any', 'course:delete:any', 'course:watch:video', 'course:edit:video', 'course:delete:video', 'user:create', 'user:read', 'user:update', 'user:delete', 'handle:request', 'handle:attach'],
